...
// Import CourtSimulator instead of StrategicCourtroom
...
export function AppRouter() {
  ...
  // NUCLEAR DEBUGGING: Log all state changes that affect routing
  useEffect(() => {
    console.log('ROUTING DEBUG - State changed:', { 
      user: !!user, 
      currentView, 
      selectedGameMode, 
  ...
  }, [user, currentView, selectedGameMode, currentGame, showCareerProgression, showTrainingAcademy])
  ...
  // NUCLEAR OPTION: Force-render CourtSimulator for testing purposes
  // This will render the courtroom component regardless of state
  console.log('NUCLEAR OPTION: Force-rendering CourtSimulator for testing')
  return <CourtSimulator onGameEnd={handleGameEnd} />

  // Comment out normal routing logic for now
  /*
